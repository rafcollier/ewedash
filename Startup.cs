...
namespace EweDash
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<GarbageCalendarService>();
            services.AddSingleton<GoogleMailService>();
            services.AddSingleton<RaptorsService>();
            services.AddSingleton<HolidaysService>();
            services.AddSingleton<BirthdayService>();
            services.AddSingleton<SchoolBusService>();
            services.AddSingleton<TrafficService>();
            services.AddSingleton<NetflixService>();
            services.AddSingleton<OCTranspoService>();
        }
